...
class AdaptiveCodec(BaseCodec):
    ...
    def __init__(self, quality=80, preprocessing='balanced', **kwargs):
        super().__init__(preprocessing=preprocessing)
        self.quality = quality
        self.jpeg_codec = JPEGCodec(quality=quality, preprocessing='none')
        self.webp_codec = WebPCodec(quality=quality, preprocessing='none')
        self.frame_count = 0
        self.use_webp = False
    ...
    def encode(self, frame):
        ...
        try:
            ...
            if self.use_webp:
                return self.webp_codec.encode(processed)
            else:
                return self.jpeg_codec.encode(processed)
...
CODEC_CONFIG = {
    ...
    'quality': 80,                    # 1-100
    'preprocessing': 'balanced',      # 'quality', 'balanced', 'fast', 'none'
